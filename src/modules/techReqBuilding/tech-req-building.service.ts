...
> {
  constructor(@InjectRepository(TechReqBuilding) techReqBuildingsService: Repository<TechReqBuilding>) {
    const relationships = ["tech", "buildingReq"];
    super(techReqBuildingsService, "techId", "buildingReqId", relationships);
  }
}
